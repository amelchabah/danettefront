...
const Home = () => {
    ...
    useEffect(() => {
        gsap.from("#titre", { duration: 1.5, opacity: 0, y: -50, ease: "ease-in-out" });
        gsap.from("#slg", { duration: 2, opacity: 0, y: -50, zoom: 1.5, ease: "fade in" });
        gsap.from("#play", { duration: 1.5, opacity: 0, y: 50, ease: "ease-in-out" });
    }, []);
        ...
        <>
            <div className="index">
                ...
                <header className="landing-header">
                    ...
                    <h4 id="slg">Créons un monde plus durable</h4>
                    <br />
                    {
                        loggedIn ? (
                            <>
                                <Link className='primary' href='/game' id="play">Jouer maintenant</Link>
                            </>) : (
                            <Link className='primary' href='/login' id="play">Jouer maintenant</Link>
                        )
                    }
                </header>
